...
def csv_reader(csvReport1, csvReport2, csvOutputReport): # Opens reports for reading

    with open(csvReport1) as csvfile1, open(csvReport2) as csvfile2:
        ...
        for row in csvReader1:
            try:
                ...
                if macAddr == '': # if no mac address
                    ipAndName = [row['IP'], row['Host Name']] # Required because append() takes only one arg
    ...
    if not e:
        ...
        output_formatter(csvReport1, macPoor, macPoorCount, macRich, macRichCount, dupeList, dupeCount)
...
if __name__ == "__main__":
    script, csvReport1, csvReport2, csvOutputReport = args
    csv_reader(csvReport1, csvReport2, csvOutputReport)
